        ...
        <div className={`fade-in ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="relative min-h-[800px]">
            ...
            <div className="absolute inset-0 pointer-events-none hidden lg:block">
              ...
              <div className="absolute top-72 left-80 w-40 h-px bg-gradient-to-r from-secondary-green to-transparent transform rotate-45 origin-left"></div>
              {/* Линия от колледжа к доп. образованию */}
              <div className="absolute top-32 left-96 w-32 h-px bg-gradient-to-r from-primary to-transparent transform -rotate-12 origin-left"></div>
            </div>

            {/* Первое окно - Колледж (увеличенное) */}
            <div className="absolute top-0 left-0 w-full max-w-lg lg:max-w-xl z-20">
            ...
            {/* Второе окно - ВУЗ (увеличенное) */}
            <div className="absolute top-96 left-1/2 transform -translate-x-1/2 lg:top-80 lg:left-1/2 lg:translate-x-8 w-full max-w-lg lg:max-w-xl z-20">
            ...
            {/* Третье окно - Дополнительное образование (увеличенное) */}
            <div className="absolute top-0 right-0 w-full max-w-md lg:max-w-lg z-20 mt-[600px] lg:mt-0">
              <Card className="bg-surface p-8 border-slate-700 shadow-2xl hover:shadow-purple-500/10 transition-all duration-300">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">Курсы и сертификации</p>
                  </div>
                </div>
