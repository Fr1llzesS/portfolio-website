...
const translations = {
  ru: {
	...
	'experience.resp2': 'Съемки и замеры горных выработок, камеральная обработка материалов съемок',
	'experience.resp3': 'Выполнение привязки проектов горных выработок к условиям местности и перенос их в натуру',
	'experience.resp4': 'Маркшейдерское сопровождение БВР/СЭР',
	'experience.resp5': 'Ведение производственной и отчетной документации',
	'experience.resp6': 'Определение и учет объемов выполненных горных работ',
	'experience.resp7': 'Мониторинг и контроль сдвижений горных пород, деформацией зданий и сооружений',
	'experience.resp8': 'Обеспечение и контроль соблюдения правил учета и хранения материалов маркшейдерских работ',
	'experience.resp9': 'Выполнение полного комплекса геодезических полевых и камеральных работ',
	'experience.resp10': 'Подготовка и оформление геодезических схем',
	'experience.resp11': 'Проверка и ведение проектной и рабочей документации',
	'experience.resp12': 'Подсчет объёмов, построение профилей, сечений, картограмм и т.д.',
	'experience.resp13': 'Построение проектно-цифровых моделей объектов строительства',
